<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="filter_manager -buy.aspx.cs" Inherits="filter_emp" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <fieldset class="fieldsetmain">
                <legend style="font-size: 20px;">BUY FILTER</legend>
    <table class="auto-style1">
        ...
        <tr>
            <td class="auto-style46">
                <asp:Label ID="Label10" runat="server" Text="Employee :"></asp:Label>
            </td>
            <td class="auto-style45">
                <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource3" DataTextField="employeefullname" DataValueField="employeeID">
                </asp:DropDownList>
            </td>
            ...
            <td class="auto-style17" colspan="9">
                <div style="height: auto; text-align: left; margin-left: 0px; margin-top: 0px; clip: rect(50px, auto, auto, auto);overflow:auto;">
                    <asp:GridView ID="GridView4" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" style="margin-left: 0px" AutoGenerateColumns="False" DataSourceID="SqlDataSource4">
                        ...
                        <Columns>
                            <asp:BoundField DataField="buytime" HeaderText="buytime" SortExpression="buytime" />
                    ...
                    <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [buytime], [buy_count], [total_price], [price], [baracode], [name], [item_unit] FROM [buy] WHERE ([bill_number] = @bill_number)">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="Label5" Name="bill_number" PropertyName="Text" Type="String" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="Id" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" PageSize="8">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Buydate" HeaderText="Buydate" SortExpression="Buydate" DataFormatString="{0:d}" />
                        <asp:BoundField DataField="employeeID" HeaderText="employeeID" SortExpression="employeeID" />
                        <asp:BoundField DataField="bill_number" HeaderText="bill_number" SortExpression="bill_number" />
                    </Columns>
        ...
        <tr>
            <td class="auto-style18" colspan="9">
                <div style="width: 282px; height: 211px">
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [Filter_Buy]">
                    </asp:SqlDataSource>
                </div>
            </td>
        ...
        <tr>
            <td colspan="12">
                <div>
                    <div>
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [buytime], [buy_count], [total_price], [price], [baracode], [name], [item_unit] FROM [buy] WHERE ([bill_number] = @bill_number)">
                            <SelectParameters>
                                <asp:ControlParameter ControlID="Label5" Name="bill_number" PropertyName="Text" Type="String" />
                            </SelectParameters>
                        </asp:SqlDataSource>
