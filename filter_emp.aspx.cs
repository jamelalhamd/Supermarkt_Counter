...
public partial class filter_emp : System.Web.UI.Page
{
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        if (RadioButtonList1.SelectedItem.ToString() == "Bill No")
        {
            ...
            string sql = "select * from  FilterSale where employeeID=@id and billnumber=@no";
        ...
        else if (RadioButtonList1.SelectedItem.ToString() == "Date")
        {
            ...
            string str = ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString;
            SqlConnection cn = new SqlConnection(str);
            string sql = "select * from  FilterSale where employeeID=@id and Saledate between @date1 And @date2";
