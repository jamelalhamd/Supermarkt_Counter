<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="filter_emp _buy.aspx.cs" Inherits="filter_emp" %>
        ...
        <tr>
            <td class="auto-style18" colspan="9">
                <div style="width: 282px; height: 211px">
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [Filter_Buy] WHERE ([employeeID] = @employeeID)">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="Label4" Name="employeeID" PropertyName="Text" Type="Int32" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                </div>
            </td>
