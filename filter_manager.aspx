<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="filter_manager.aspx.cs" Inherits="filter_emp" %>
    ...
    <table class="auto-style1">
        ...
        <tr>
            <td colspan="12">
                <div>
                    <div>
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [saletime], [employeeid], [salecount], [saletotall], [unitprice], [baracode], [itemunit], [billnumber], [name] FROM [sale] WHERE ([billnumber] = @billnumber)">
                            <SelectParameters>
                                <asp:ControlParameter ControlID="Label5" Name="billnumber" PropertyName="Text" Type="String" />
                            </SelectParameters>
                        </asp:SqlDataSource>
